...
namespace B21_Ex01_1
{
     class Program
     {
          ...
          {
               //string firstBinStr, secondBinStr, thirdBinStr;
               ...
               avgNumOfOnesInInput = k_InputLength - sumOfNumOfZerosInInput;

               string msg = string.Format(@"The number of numbers that are a power of 2: {0},
The Number of numbers that are an ascending series: {1}, 
The average number of '1' is: {2},
The average number of '0' is: {3},
The biggest number is: {4}, 
And the smallest number is: {5}",
howManyNumsArePowerOf2, howManyNumsAnAscendingSeries, avgNumOfOnesInInput, avgNumOfZerosInInput, maxNum, minNum);
          ...
          {
               bool isStrPowerOf2 = io_Str[0] == '1';

               for (int i = 1; i < io_Str.Length && isStrPowerOf2; i++)
               {
                    if (io_Str[i] != '0')
                    {
                         isStrPowerOf2 = false;
